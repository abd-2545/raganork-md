...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~dbd283b83e98b27af15dc40cd48a6603:305a5933592f4855446d6f3d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '923071003071-1632403322@g.us,120363116963909366@g.us',
    ...
    ALLOWED: process.env.ALLOWED || '91,92',
    NOT_ALLOWED: process.env.ALLOWED || '91,92',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Raganork",
    BOT_NAME: process.env.BOT_NAME || 'HAKEEM',
